...
public interface ThermostatPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default int getTemp(java.util.Map<String, String> context)
        throws ThermostatIsOff
    {
        try
        {
            return _iceI_getTempAsync(context, true).waitForResponseOrUserEx();
        }
        catch(ThermostatIsOff ex)
        {
            throw ex;
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> getTempAsync()
    {
        return _iceI_getTempAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> getTempAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_getTempAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getTemp", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_getTemp);
        f.invoke(true, context, null, null, istr -> {
                     int ret;
                     ret = istr.readInt();
                     return ret;
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getTemp =
    {
        ThermostatIsOff.class
    };

    default void setTemp(int temp)
        throws ThermostatIsOff,
               TooCold,
               TooHot
    {
    ...
    default void setTemp(int temp, java.util.Map<String, String> context)
        throws ThermostatIsOff,
               TooCold,
               TooHot
    {
    ...
    default java.util.concurrent.CompletableFuture<Void> setTempAsync(int temp)
    {
        return _iceI_setTempAsync(temp, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setTempAsync(int temp, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setTempAsync(int iceP_temp, java.util.Map<String, String> context, boolean sync)
    {
    ...
    {
        return "::HouseAdultsOnly::Thermostat";
    }
}
